...
function UIEvent(type) {
  if (!new.target) {
    throw new TypeError("Failed to construct 'UIEvent'. Please use the 'new' operator; this constructor cannot be called as a function.");
  }
...
UIEvent.prototype[Symbol.toStringTag] = "UIEvent";
